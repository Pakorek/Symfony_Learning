 ...
 */
final class Version20200615083535 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD username VARCHAR(45) NOT NULL, ADD bio LONGTEXT DEFAULT NULL');
    }
